...
<div class="fLeft"><span id="key"><input type="text" name="regionname" title="地区查询" class="medium" ></span></div>
...
<div class="list" >
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="list" cellpadding=0 cellspacing=0 ><tr><td height="5" colspan="6" class="topTd" ></td></tr><tr class="row" ><th width="8"><input type="checkbox" id="check" onclick="CheckAll('checkList')"></th><th width="6%"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照编号<?php echo ($sortType); ?> ">编号<?php if(($order) == "id"): ?><img src="../Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('regionname','<?php echo ($sort); ?>','index')" title="按照地区名称<?php echo ($sortType); ?> ">地区名称<?php if(($order) == "regionname"): ?><img src="../Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th width="5%"><a href="javascript:sortBy('displayorder','<?php echo ($sort); ?>','index')" title="按照显示顺序<?php echo ($sortType); ?> ">显示顺序<?php if(($order) == "displayorder"): ?><img src="../Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th width="5%"><a href="javascript:sortBy('status','<?php echo ($sort); ?>','index')" title="按照状态<?php echo ($sortType); ?> ">状态<?php if(($order) == "status"): ?><img src="../Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$videoregion): $mod = ($i % 2 );++$i;?><tr class="row" onmouseover="over(event)" onmouseout="out(event)" onclick="change(event)" ><td><input type="checkbox" name="key"	value="<?php echo ($videoregion["id"]); ?>"></td><td><?php echo ($videoregion["id"]); ?></td><td><a href="javascript:edit('<?php echo (addslashes($videoregion["id"])); ?>')"><?php echo ($videoregion["regionname"]); ?></a></td><td><?php echo ($videoregion["displayorder"]); ?></td><td><?php echo (getstatus($videoregion["status"])); ?></td><td> <?php echo (showstatus($videoregion["status"],$videoregion['id'])); ?>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tr><td height="5" colspan="6" class="bottomTd"></td></tr></table>
<!-- Think 系统列表组件结束 -->
