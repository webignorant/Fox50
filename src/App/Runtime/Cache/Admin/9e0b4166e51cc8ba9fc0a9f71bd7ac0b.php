...
<div class="content">
<div class="title">编辑友情链接 [ <a href="__URL__">返回列表</a> ]</div>
<table cellpadding=3 cellspacing=3>
<form method='post' id="form1" action="__URL__/update/" >
<tr>
	<td class="tRight" >站点名称:</td>
	<td class="tLeft" ><input type="text" class="medium bLeftRequire"  check='Require' id="account" name="name" value="<?php echo ($vo["name"]); ?>"></td>
</tr>
<tr>
	<td class="tRight" >URL:</td>
	<td class="tLeft" ><input type="text" class="medium bLeft" name="url" value="<?php echo ($vo["url"]); ?>"></td>
</tr>

<tr>
	<td class="tRight" >说明文字：</td>
	<td class="tLeft" ><input type="text" class="medium bLeft" name="description" value="<?php echo ($vo["description"]); ?>"></td>
</tr>
<!--
<tr>
	<td class="tRight">LOGO地址：</td>
	<td class="tLeft"><input type="text" class="medium bLeft" name="logo" value="<?php echo ($vo["logo"]); ?>"></td>
</tr>
-->
<tr>
